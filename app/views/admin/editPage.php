...
<div class="w-4/5 m-auto pt-20">
    ...
    <form action="<?php echo URL_GEN;?>admin/updatePage/<?php echo $data['page']->id; ?>" 
          method="POST"
          enctype="multipart/form-data"
          >


          <input type="text" name="title" placeholder="title" class="block bg-transparent border-b-2 w-full  outline-none" value="<?php echo $data['page']->title; ?>">

          <textarea name="content" placeholder="content page... "  class="py-5 bg-transparent border-b-2 w-full h-60   outline-none">
          <?php    echo $data['page']->content; ?>  
          </textarea>
          <input type="hidden" name="image_value" id="image_value" value="<?php echo $data['page']->image; ?>">
          <button id="preview" type="button"> change <img src="<?php echo URL_IMAGES.$data['page']->image; ?>"  class="h-20" ></button>
